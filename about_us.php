...
<img src="statics/abstbg2.png" alt="" style="width:100%; position:absolute; z-index:-1;">
    ...
    <center>
        <div class="container" style="margin-top: 7.5%; padding:10px 10px 10px 80px; ">
            <div
                style="width:50%; background-color:rgba(0,0,10,1); padding:5px 5px 5px 5px; border-radius:10px; box-shadow: 2px 2px 10px gray;">
                <h1 style=" color:yellow;">About Us</h1>
            </div>
            <br><br>
            <img src="statics/kshitij.jpeg" alt="" style="width:20%; box-shadow:15px 15px 15px black;">
            <br><br>
            <p style="color:white;">This website is created by</p>
            <h1 style="color:yellow; text-shadow:2px 2px 2px blue;">Kshitij Wani</h1>
            <p style="color:gray;"><b>Intern at Sparks Foundation <br> Pimpri Chinchwad College of Engineering, Pune</b></p>
    </center>
