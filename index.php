...
<div id="lock"><img src="statics/PngItem_5146697.png" alt="" style="width:50%; margin-left:50%;"><br>
...
<div id="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        style="font-family:candara; font-size:18px; box-shadow: 0px 0px 10px 0px blue;">
    ...
    <div class="container-large"
        style="color:yellow; height:500px; width: 100%; padding:8% 2% 2% 2%; background-color:rgb:(60,60,60);">
   
    <img src="statics/abstbg2.png" alt="" style="width:100%; position:absolute; z-index:-1">

    <center style="margin:60px 0px 20px 0px;">
        
            <h1 style="text-shadow:2px 2px 2px blue; color:yellow;"><b>Welcome to Bank of SPARKS</b></h1>
            <h1 style="text-size:2px;text-shadow:2px 2px 2px blue; color:white;"><b>Our services</b></h1>
            <div class="container" style="margin:30px 0px 20px 0px; color:black">
                <div class="row">
                    <div class="col-lg">
                        <div
                            style="backdrop-filter: blur(10px); color:white; width: 90%; border-radius:0px; box-shadow:3px 3px 8px gray; padding:20px 10px 20px 10px;">
                            <i class="fas fa-user-circle fa-7x"></i><br><br>
                            <a href="all_cust.php"><button type="button" class="btn btn-outline-light mybtn">View
                                    Customers</button></a><br>
                            <h6>Bank Customers details</h6>
                        </div>
                    </div>
                    <div class="col-lg">
                        <div
