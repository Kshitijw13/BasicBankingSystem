...
<body style="background-color:#000000; padding-top:8%;">
<img src="statics/abstbg2.png" alt="" style="width:100%; position:absolute; z-index:-1">
    ...
    <center>
        ...
        <div class="container" style="margin-top:2%;">
            <div
                style="width:80%; backdrop-filter: blur(10px); padding:5px 5px 5px 5px; border-radius:0px; box-shadow: 2px 2px 10px black;">
                <h1 style=" color:white;">Transfer Money</h1>
            </div>
            <br><br>
            <div class="" style=" backdrop-filter: blur(5px);  border-radius:5px; box-shadow: 2px 2px 10px black  ">
                <form action="send_money.php" method="post">
                    ...
                    <p style="color:white;">Current Balance: <a href="check_blc.php">Check Balance</a></p>
                </form>
            </div>
        </div>
