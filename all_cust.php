...
<head>
    ...
    <title>All customers - Kshitij Bank</title>
...
<img src="statics/abstbg2.png" alt="" style="width:100%; position:absolute; z-index:-1">
    ...
    <center>
        ...
        <div class="container" style="margin-top: 8%; padding:10px 80px 10px 80px; ">
            <div
                style="width:80%; background-color:rgba(0,0,0,.5); padding:5px 5px 5px 5px; border-radius:0px; box-shadow: 2px 2px 10px blue;">
